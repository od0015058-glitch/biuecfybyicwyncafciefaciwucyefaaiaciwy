...
1. Row 17 — real `/health` endpoint (P1 ops, fast, foundation).
2. Row 20 — abuse / spam detection (P0 security).
3. Row 19 — AI feedback 👍 / 👎 (P2 product, fast).
4. Row 4 — streaming responses (P2 product, biggest UX win).
