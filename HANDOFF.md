...
18. **Stage-15-Step-E #8 follow-up #2 OPENED** (PR-after-#147) —
...
19. **Working rule:** push PRs sequentially, bundle a real bug fix in each,
    update this doc + README in each, do NOT block on user approval. The
    user merges them when they wake up.
20. **Read the §11 working agreement before doing anything.**
